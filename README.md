...
2. Запустите тесты:
   ...
   Ожидается `Ran 4 tests` и `OK`. Тесты повторно рассчитывают CSV, сравнивают их с готовыми файлами в `submission/`, проверяют полный охват `gid`, защиту обрыва четвёртого колена, порядок переводов и поиск произвольного узла.
