...
- Три CSV-файла по схеме кейса и локальная страница для поиска любого `gid`: расшифровка роли и баллов, объяснение стрелок, сведения о кластере, направленные связи и причины попадания каждого узла в топ-20.
