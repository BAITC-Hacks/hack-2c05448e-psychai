...
- Три CSV-файла по схеме кейса, готовый снимок выгрузок в [submission/](submission/README.md) и локальная страница: обзор сети с числом клиентов, связей, исходных клиентов и групп, распределение ролей, группы с крупнейшим внутренним оборотом, поиск любого `gid`, объяснение его роли и связей, причины попадания в топ-20.
