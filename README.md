...
- Три CSV-файла по схеме кейса, готовый снимок выгрузок в [submission/](submission/README.md) и локальная страница для поиска любого `gid`: расшифровка роли и баллов, объяснение стрелок, сведения о кластере, направленные связи и причины попадания каждого узла в топ-20.
